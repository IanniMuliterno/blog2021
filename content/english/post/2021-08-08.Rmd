...
![The RStudio logo](https://www.rstudio.com/wp-content/uploads/2016/09/RStudio-Logo-Blue-Gray-250.png){.logo}
  ...
  Fiz leituras recentes que enriqueceram bastante minha rotina, para usar um termo mais lúico e apaixonado : Sabe aquele livro que muda sua vida?
  
  Para mim esses livros foram Foco, por Daniel Goleman e O andar do bêbado, por Leonard Mlodinow. Hoje, resolvi falar sobre o segundo, porque foi uma aula para mim e quero me certificar de que entendi ele, então espere encontrar aqui um resumo com 'breaks' para comentários e demonstrações de alguns dos casos curiosos citados por Leonard.
  
  A primeira curiosidade que me fez abrir o R e simular foi:
